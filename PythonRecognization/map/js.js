var map;
var overlay;
var poiIconWidth = 800;
var poiIconHeight = 1000;
var zIndex = 100;
var poiMarkerArry = [];
var binDimensions;
var binXoffset = 10;
...
function generatePoiMarkerlist() {
    ...
    for (var i = 0; i < poiData.length; i++) {
        var content =  poiData[i].name + '<img data-id="' + poiData[i].id +
            '" data-index="' + i + '" class="map_icon" width=50px src="' + poiData[i].icon + '" />';
